...
public class ProfessionTool extends Profession {
    ...
    public ListTag<Tag> buildTrades(int seed) {
        ...
        recipes.add(RecipeBuildUtils.of(createItem("minecraft:coal", 15), createItem("minecraft:emerald", 1))
                        ...
                        .setTraderExp(2)
                        .build())
                .add(RecipeBuildUtils.of(createItem("minecraft:emerald", 1), createItem("fireshaldrpg:copper_axe", 1))
                        .setMaxUses(12)
                        .setRewardExp((byte) 1)
                        .setTier(1)
                        .setTraderExp(1)
                        .build())
                .add(RecipeBuildUtils.of(createItem("minecraft:emerald", 1), createItem("fireshaldrpg:copper_shovel", 1))
                        .setMaxUses(99)
                        .setRewardExp((byte) 1)
                        .setTier(1)
                        .setTraderExp(0)
                        .build())
                .add(RecipeBuildUtils.of(createItem("minecraft:emerald", 1), createItem("fireshaldrpg:copper_pickaxe", 1))
                        .setMaxUses(99)
                        .setRewardExp((byte) 1)
                        .setTier(1)
                        .setTraderExp(0)
                        .build())
                .add(RecipeBuildUtils.of(createItem("minecraft:emerald", 1), createItem("fireshaldrpg:copper_hoe", 1))
                        .setMaxUses(99)
                        .setRewardExp((byte) 1)
                        .setTier(1)
                        .setTraderExp(0)
