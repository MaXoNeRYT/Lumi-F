...
public abstract class StringItemArmorBase extends ItemArmor implements StringItem {

    private final String namespaceId;

    public StringItemArmorBase(@NotNull String namespaceId, @Nullable String name) {
    ...
    @Override
    public StringItemArmorBase clone() {
        return (StringItemArmorBase) super.clone();
    }
}
